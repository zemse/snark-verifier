...
/// permutation step.
#[derive(Debug, Clone)]
pub struct OptimizedPoseidonSpec<F: FieldExt, const T: usize, const RATE: usize> {
    pub(crate) r_f: usize,
...
#[derive(Clone, Debug)]
pub struct MDSMatrix<F: FieldExt, const T: usize, const RATE: usize>(pub(crate) Mds<F, T>);
